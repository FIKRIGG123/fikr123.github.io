...
// Dirubah 
const pengirim = "Fikri";
const nomorWa = "6283123740781" // awalan nomor 0 harus di awalin 62
...
hilang1.addEventListener('click', () => {
  ...
  Swal.fire({
    ...
    imageHeight: 120,
    title: 'Halo Kenalan Dong, Tulis Nama Kamu',
    ...
    preConfirm: () => {
      ...
      if (!login) {
        Swal.showValidationMessage(`Masukin Nama Kamu Dong, HIIIIIH :(`)
      }
      return { login }
    }
  }).then((result) => {
